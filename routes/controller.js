...
var addItem = function(req, res, function_name) {
  ...
  Fabric_Client.newDefaultKeyValueStore({ path: store_path })
    ...
    .then((user_from_store) => {
      ...
      console.log('invoke the chaincode...................');
    })
    .then((results) => {
  ...
  req.flash('success', 'Phát hành thành công!');
  res.redirect('/');
};

var queryFood = function(req, res) {
  res.render('queryFood');
};

var queryItem = function(req, res, function_name) {
  var fabric_client = new Fabric_Client();
  ...
  Fabric_Client.newDefaultKeyValueStore({ path: store_path })
    ...
    .then((user_from_store) => {
      ...
      // queryItem - requires 1 argument, ex: args: ['4'],
      const request = {
        chaincodeId: 'supplychain',
        txId: tx_id,
        fcn: function_name,
